 ...
 */
public class EmergencyServicesManagerController implements Initializable {
    @FXML
    private Button Logout;
    @FXML
    private Button Ambulance;
    @FXML
    private Button HospitalBeds;
    ...
    @FXML
    private void HospitalBedsOnAction(ActionEvent event) {
        try {
    ...
    @FXML
    private void AmbulanceOnAction(ActionEvent event) {
        try {
