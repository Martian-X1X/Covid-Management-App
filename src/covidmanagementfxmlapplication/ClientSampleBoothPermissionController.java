 ...
 */
public class ClientSampleBoothPermissionController implements Initializable {
    ...
    private void AcceptonAction(ActionEvent event) {
        try {
            Parent backscene = FXMLLoader.load(getClass().getResource("ClientSampleBoothLocations.fxml"));
    ...
    @FXML
    private void DenyOnAction(ActionEvent event) {
        try {
            Parent backscene = FXMLLoader.load(getClass().getResource("Client.fxml"));
            Scene sceneback = new Scene(backscene);
