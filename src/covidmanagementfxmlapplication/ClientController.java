...
public class ClientController implements Initializable {
    ...
    @FXML
    private Button SampleBooth;
    @FXML
    private Button CovidGuidelines;
    ...
    @FXML
    private void SampleBoothOnAction(ActionEvent event) {
        try {
            Parent backscene = FXMLLoader.load(getClass().getResource("ClientSampleBoothPermission.fxml"));
            Scene sceneback = new Scene(backscene);
    ...
    @FXML
    private void CovidGuidelinesOnAction(ActionEvent event) {
        try {
            Parent backscene = FXMLLoader.load(getClass().getResource("ClientGuidelines.fxml"));
            Scene sceneback = new Scene(backscene);
